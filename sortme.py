...
if __name__ == '__main__':
    fil = open("C:\Users\AKINTOLA OLUWASEUN\Desktop\python\Python\PythonHomework.txt","w")
    with open("C:\Users\AKINTOLA OLUWASEUN\Desktop\python\Python\month.csv", "r") as f:
